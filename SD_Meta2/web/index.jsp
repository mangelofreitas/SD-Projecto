	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right">
				...
				<li>
					<a data-toggle="modal" href="#Signup" class="btn btn-primary" style="margin-left: 10px; margin-right: 10px; height:50px">Sign up</a>
				</li>
				<li>
					<a data-toggle="modal" href="#Login" class="btn btn-primary" style="margin-left: 10px; margin-right: 10px; height:50px">Log in</a>
				</li>
			</ul>
		</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form action="login" style="text-align:center" class="login-block" method="post">
							<input id="mail" type="text" class="form-control" placeholder="Mail" name="Mail"/><br>
							<input id="password" type="password" class="form-control" placeholder="Password" name="Password"/><br>
							<input type="submit" class="btn btn-block" method="execute">
						</form>
						<div class="modal-footer">
							<a href="#" data-dismiss="modal" class="btn">Close</a>
						</div>
